            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="objeto in arrayRol" :key="objeto.id">                                
...
<script>
    export default {
        data() {
            return {
                arrayRol:[],
                rol_id: 0, //es el id de la tabla categoria
                nombre: '',
                descripcion: '',
                //MODAL
                modal: 0,
        ...
        methods: {
            ...
            listarRol (page,buscar,criterio){ //page de la paguinacion y las dos variables otras son las de buscar
                let me = this;
                var url= '/rol?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;//concatenamos y enviamos los parametros en la ruta de buscar y paguinacion
                axios.get(url)
                .then(function(response){
                    var respuesta = response.data;
                    me.arrayRol = respuesta.roles.data;//categorias es del index del controller
