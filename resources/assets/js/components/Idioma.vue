        ...
        <div class="modal-dialog modal-primary modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button v-show="accion==0" type="button" @click="regIdioma" class="btn btn-primary">Guardar</button>
                    <button v-show="accion" type="button" @click="actIdioma" class="btn btn-primary">Actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listIdioma(page,criterio,buscar);
            },
            listIdioma:function(page,criterio,buscar){
                let me = this;
            ...
            regIdioma(){
                ...
                .then(function(response){
                    me.listIdioma();
                    me.mensaje('Se registro correctamente');
                })
                .catch(function(error){
                    console.log(error);
                });
        ...
        mounted() {
            ...
            this.listIdioma(1,this.criterio,this.buscar);
        }
    }
</script>
